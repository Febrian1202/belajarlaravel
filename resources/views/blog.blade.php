    ...
    <div class="min-h-full">
        <nav class="bg-gray-800/50">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/blog"
                                    class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Blog</a>
                                <a href="/about"
            ...
            <el-disclosure id="mobile-menu" hidden class="md:hidden [&:not([hidden])]:block">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="/blog"
                        class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">Blog</a>
                    <a href="/about"
        ...
        <header
            ...
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-white">Blog</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
