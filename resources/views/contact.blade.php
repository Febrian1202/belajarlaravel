        ...
        <nav class="bg-gray-800/50">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/contact"
                                    class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Contact</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
            ...
            <el-disclosure id="mobile-menu" hidden class="md:hidden [&:not([hidden])]:block">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="/contact"
                        class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">Contact</a>
                </div>
